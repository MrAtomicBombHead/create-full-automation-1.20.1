...
public class ModEntities {
    ...
    public static final EntityType<GlowInkBottleEntity> GLOW_INK_BOTTLE_ENTITY = Registry.register(Registry.ENTITY_TYPE,
    ...
    public static final EntityType<InkBottleEntity> INK_BOTTLE_ENTITY = Registry.register(Registry.ENTITY_TYPE,
